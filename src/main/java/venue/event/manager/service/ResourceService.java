...
import venue.event.manager.domain.model.resource.Resource;
import venue.event.manager.domain.model.resource.ResourceType;
...
import venue.event.manager.repository.EquipmentRepository;
import venue.event.manager.repository.EventRepository;
import venue.event.manager.repository.ServiceRepository;
import venue.event.manager.repository.SpaceRepository;
